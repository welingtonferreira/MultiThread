...
begin
  try
    frmHistoricoDownload.Show; //Exibe o form2 que contém os dados do banco
  except
    on E: Exception do
    begin
...
begin
  try
    ...
    on E: Exception do
    begin
      ShowMessage('Erro FormCreate' + E.Message); //Mensagem de Erro de conexão com o banco
    end;
  end;
end;
...
begin
  try
    ...
    on E: Exception do
    begin
      ShowMessage('Erro IdHTTP1Work' + E.Message); //Mensagem de Erro de conexão com o banco
    end;
  end;
end;
...
begin
  try
    ...
    on E: Exception do
    begin
      ShowMessage('Erro IdHTTP1WorkBegin' + E.Message); //Mensagem de Erro de conexão com o banco
    end;
  end;
end;
